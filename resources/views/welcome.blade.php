...
<head>
    ...
    <!-- PAGE TITLE -->
    <title>CKav | Spar - Multipurpose HTML Template</title>
    ...
    <meta name="description" content="Spar - Multipurpose HTML Template">
    ...
    <link rel="stylesheet" href="vendor/youtubebackground/css/jquery.mb.YTPlayer.min.css">
    ...
    <div class="home-area intro-section flex-cc" data-ckav-smd="padding-b-0 flex-cc">
        <div class="container zindex-1 intro-element">
            ...
            <div class="intro-text typo-light" data-ckav-smd="align-center">
                <h2 class="heading xlarge bold-900 text-upper" data-ckav-smd="large">Fashion Trend</h2>
                <p class="heading-sub width-50" data-ckav-smd="width-100 mini">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestiae alias minus eos nihil.
                </p>
        ...
        <div class="bg-holder zindex-0">
            ...
            <!-- BACKGROUND IMAGE -->
            <b data-bgholder="slideshow" class="full-wh bg-cover bg-cc zindex-1" data-slide-image="images/slideshow-01.jpg|images/slideshow-02.jpg|images/slideshow-03.jpg"></b>
   ...
   *************************************************************
    ...
    *************************************************************
    ...
    <div class="popup-area">
            ...
            <div class="inner-section animated" data-anim-in="fadeIn" data-anim-out="fadeOut">
                <div class="container">
                    ...
                    <div class="row align-items-center gt60">
                        <div class="col-lg-6">
                            <div class="image-wrapper animated" data-anim-in="fadeInRight" data-ckav-smd="margin-b-30">
                        ...
                        <div class="col-lg-6">
                            <div class="section-heading-wrapper" data-ckav-smd="align-center">
                                <h2 class="heading-section text-upper default bold-900 animated" data-anim-in="fadeInUp" data-ckav-smd="medium">About us</h2>
                            ...
                            <hr class="color-border-default margin-tb-30 width-px-50 margin-l-0 border-t-2 animated" data-anim-in="fadeInUp|0.2" data-ckav-smd="margin-auto">
                            <p class="margin-b-20 animated" data-anim-in="fadeInUp|0.2">
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque, non? Minima, nobis velit officia est autem veniam. Quidem, omnis asperiores? Temporibus repudiandae blanditiis sit dolore tempore. Illo voluptatem sunt maxime. Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem, suscipit vel. At assumenda placeat deserunt minus necessitatibus optio recusandae quasi iste illo alias vel cumque, tempora ipsam voluptates cum a!
                            </p>
                            <ul class="list-1 color-text-white font-01" data-ckav-smd="align-left margin-b-30">
                                ...
                                <li class="margin-b-5 animated" data-anim-in="fadeInUp|0.4"><i class="list-bullet margin-r-10 color-text-default fas fa-angle-right"></i> Ullamco laboris nisi ut aliquip.</li>
                                <li class="margin-b-5 animated" data-anim-in="fadeInUp|0.5"><i class="list-bullet margin-r-10 color-text-default fas fa-angle-right"></i> Eiusmod tempor incididunt ut labore.</li>
                                <li class="margin-b-5 animated" data-anim-in="fadeInUp|0.5"><i class="list-bullet margin-r-10 color-text-default fas fa-angle-right"></i> Consectetur adipisicing elit seddo.</li>
                                <li class="margin-b-5 animated" data-anim-in="fadeInUp|0.6"><i class="list-bullet margin-r-10 color-text-default fas fa-angle-right"></i> Utenim ad minim veniam quis.</li>
                            </ul>
                        </div>
                    </div>
        ...
        = TEAM SECTION
        ==================================-->
        <div id="team" class="popup-section team-section typo-light">
            ...
            <div class="inner-section animated" data-anim-in="fadeIn" data-anim-out="fadeOut">
                <div class="container">
                    ...
                    <div class="carousel-widget carouselnav-1 zoom-carousel large padding-b-0 width-90 margin-auto animated" data-anim-in="fadeIn|0.2" data-ckav-smd="width-100 align-center"
                            ...
                            <div class="item">
                                <div class="inneritem">
                                    ...
                                    <div class="hover-box teambox radius-10 teambox-02 hover-box-01">
                                        ...
                                        <div class="overlay flex-bl radius-10 typo-light" data-linear-gradient="rgba(31,34,41,0.5)|rgba(31,34,41,1)">
                                            <div class="info-text text-center">
                                                <em class="fs12 color-text-white margin-b-5">Marketing</em>
                                                <h3 class="heading-content mini bold-600 margin-0">Uasto Polor</h3>
                                                <div class="social-links margin-t-20">
                                                    <a href="#" target="_blank" class="button button-icon color-button-white border-glass fs-12 margin-lr-5 square-30"><i class="fab fa-facebook-f"></i></a>
                                                    <a href="#" target="_blank" class="button button-icon color-button-white border-glass fs-12 margin-lr-5 square-30"><i class="fab fa-twitter"></i></a>
                                                    <a href="#" target="_blank" class="button button-icon color-button-white border-glass fs-12 margin-lr-5 square-30"><i class="fab fa-linkedin-in"></i></a>
                            ...
                            <div class="item">
                                <div class="inneritem">
                                    ...
                                    <div class="hover-box teambox radius-10 teambox-02 hover-box-01">
                                        ...
                                        <div class="overlay flex-bl radius-10 typo-light" data-linear-gradient="rgba(31,34,41,0.5)|rgba(31,34,41,1)">
                                            <div class="info-text text-center">
                                                <em class="fs12 color-text-white margin-b-5">Programmer</em>
                                                <h3 class="heading-content mini bold-600 margin-0">Molto Rilor</h3>
                                                <div class="social-links margin-t-20">
                                                    <a href="#" target="_blank" class="button button-icon color-button-white border-glass fs-12 margin-lr-5 square-30"><i class="fab fa-facebook-f"></i></a>
                                                    <a href="#" target="_blank" class="button button-icon color-button-white border-glass fs-12 margin-lr-5 square-30"><i class="fab fa-twitter"></i></a>
                                                    <a href="#" target="_blank" class="button button-icon color-button-white border-glass fs-12 margin-lr-5 square-30"><i class="fab fa-linkedin-in"></i></a>
                            ...
                            <div class="item">
                                <div class="inneritem">
                                    ...
                                    <div class="hover-box teambox radius-10 teambox-02 hover-box-01">
                                        ...
                                        <div class="overlay flex-bl radius-10 typo-light" data-linear-gradient="rgba(31,34,41,0.5)|rgba(31,34,41,1)">
                                            <div class="info-text text-center">
                                                <em class="fs12 color-text-white margin-b-5">Support</em>
                                                <h3 class="heading-content mini bold-600 margin-0">Yupsum Topor</h3>
                                                <div class="social-links margin-t-20">
                                                    <a href="#" target="_blank" class="button button-icon color-button-white border-glass fs-12 margin-lr-5 square-30"><i class="fab fa-facebook-f"></i></a>
                                                    <a href="#" target="_blank" class="button button-icon color-button-white border-glass fs-12 margin-lr-5 square-30"><i class="fab fa-twitter"></i></a>
                                                    <a href="#" target="_blank" class="button button-icon color-button-white border-glass fs-12 margin-lr-5 square-30"><i class="fab fa-linkedin-in"></i></a>
                                        ...
                                        <!-- IMAGE -->
                                        <img class="radius-10" src="images/400x500-04.jpg" alt="portfolio image">
                                    </div>
                    ...
                    <div class="row align-items-center gt60">
                        <div class="col-lg-8">
                            <div class="row gt10 margin-b-10" data-ckav-smd="margin-b-0">
                                <div class="col-lg-6 animated" data-anim-in="fadeInUp|0.1" data-ckav-smd="margin-b-30">
                                    <div class="info-obj radius-10 margin-b-0 center info-box-01 img-t padding-40 gap-20 mini bgcolor-default">
                                        <div class="img"><span class="iconwrp color-text-white"><i class="pe-7s-rocket"></i></span></div>
                                        <div class="info">
                                            <h3 class="heading-content bold-700 text-upper margin-b-10 tiny">Marketing</h3>
                                            <p class="margin-b-0">1orem ipsum eirmod dolor sit ametconsetetur sadipscing nonumy ipsum eirmod</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 animated" data-anim-in="fadeInUp|0.2" data-ckav-smd="margin-b-30">
                                    <div class="info-obj radius-10 margin-b-0 center info-box-01 img-t padding-40 gap-20 mini bgcolor-default">
                                        <div class="img"><span class="iconwrp color-text-white"><i class="pe-7s-display2"></i></span></div>
                                        <div class="info">
                                            <h3 class="heading-content bold-700 text-upper margin-b-10 tiny">Coding</h3>
                                            <p class="margin-b-0">1orem ipsum eirmod dolor sit ametconsetetur sadipscing nonumy ipsum eirmod</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row gt10">
                                <div class="col-lg-6 animated" data-anim-in="fadeInUp|0.3" data-ckav-smd="margin-b-30">
                                    <div class="info-obj radius-10 margin-b-0 center info-box-01 img-t padding-40 gap-20 mini bgcolor-default">
                                        <div class="img"><span class="iconwrp color-text-white"><i class="pe-7s-rocket"></i></span></div>
                                        <div class="info">
                                            <h3 class="heading-content bold-700 text-upper margin-b-10 tiny">Marketing</h3>
                                ...
                                <div class="col-lg-6 animated" data-anim-in="fadeInUp|0.4" data-ckav-smd="margin-b-30">
                                    <div class="info-obj radius-10 margin-b-0 center info-box-01 img-t padding-40 gap-20 mini bgcolor-default">
                                        <div class="img"><span class="iconwrp color-text-white"><i class="pe-7s-display2"></i></span></div>
                                        <div class="info">
                                            <h3 class="heading-content bold-700 text-upper margin-b-10 tiny">Coding</h3>
                        ...
                        <div class="col-lg-4" data-ckav-smd="margin-t-30">
                            <div class="section-heading-wrapper" data-ckav-smd="align-center">
                                <h2 class="heading-section text-upper default bold-900 animated" data-anim-in="fadeInRight|0.1" data-ckav-smd="medium">Services</h2>
                                <p class="heading-section-sub small margin-b-0 animated" data-anim-in="fadeInRight|0.1" data-ckav-smd="mini">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, quaerat architecto iusto nostrum dignissimos consectetur sit corrupti quos sed.
                                </p>
                            </div>
                            <hr class="color-border-default margin-tb-30 width-px-50 margin-l-0 border-t-2 animated" data-anim-in="fadeInRight|0.2" data-ckav-smd="margin-auto margin-tb-20">
                            <p class="margin-b-20 animated" data-anim-in="fadeInRight|0.2" data-ckav-smd="align-center">
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque, non? Minima, nobis velit officia est autem veniam. Quidem, omnis asperiores? Temporibus repudiandae blanditiis sit dolore tempore. Illo voluptatem sunt maxime.
                            </p>
                        </div>
                    </div>
    ...
    *************************************************************
    ...
    <div class="footer-area intro-element">
        <div class="container">
            <p class="c-text">
                <a class="c-text" href="#" target="_blank">Spar - Multipurpose HTML Template</a> © <script>document.write(new Date().getFullYear());</script>
            </p>
        </div>
    </div>
    <!-- ************** END : FOOTER **************  -->
...
<script src="vendor/youtubebackground/jquery.mb.YTPlayer.min.js"></script>

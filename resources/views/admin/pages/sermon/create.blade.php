                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" name="title" class="form-control" placeholder="Sermon Title" value="{{ old('title') }}" required data-validation-required-message="This title field is required" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="controls">
                                                    <label>Sermon Theme</label>
                                                    <input type="text" name="theme" class="form-control" placeholder="example: Encounter with destiny..." autocomplete="off" value="{{ old('theme') }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="controls">
                                                    <label>Sermon Introduction *</label>
                                                    <textarea type="text" name="intro" class="form-control" placeholder="example: Encounter with destiny..." required data-validation-required-message="This title field is required" autocomplete="off">{{ old('intro') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="date" name="date" value="{{ old('date') }}" class="form-control" placeholder="Date" required data-validation-required-message="This field is required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <select name="preacher_id" class="form-control" required>
                                                        ...
                                                        @foreach($preachers as $preacher)
                                                            <option value="{{ $preacher->uuid }}" {{ $preacher->uuid===old('preacher_id')?'selected':'' }}>{{ $preacher->fullname }}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <label>Sermon</label>
                                                    <textarea type="date" name="info" rows="30" class="form-control myfield" placeholder="Information" data-validation-required-message="This field is required">{{ old('info') }}</textarea>
                                                </div>
                                            </div>
                                        </div>

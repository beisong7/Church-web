            ...
            <div class="table-responsive">
                <table class="table data-list-view">
                    ...
                    @foreach($services as $service)
                        <tr>
                            <td></td>
                            <td class="product-category">{{ $service->title }}</td>
                            <td class="product-category">{{ $service->theme }}</td>
                            <td class="product-category">{{ date('F d, Y', $service->date) }}</td>
                            <td class="product-category">{{ $service->active?'Yes':'No' }}</td>
                            <td class="product-action">
                                <a href="{{ route('service.toggle', $service->uuid) }}" class="ml-2 text-white">
                                    @if($service->active)
                                ...
                                <a href="{{ route('service.edit', $service->uuid) }}" class="ml-2 text-white">
                                    <i title="Start Edit" class=" feather icon-edit"></i>
                                </a>
                                <span title="Delete Immediately" class="ml-2 action-delete" data-uuid="{{ $service->uuid }}"><i class="feather icon-trash"></i></span>
                            </td>
                        </tr>
                    @endforeach
...
//                console.log(uuid);
                var route = '{{ route('service.pop') }}'+'?uuid='+uuid;
                $.ajax({
                    type:'GET',
                    url: route,
                    data:{

                        ...
                        <ul class="nav nav-tabs mb-3" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                    <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">New Role</span>
                                </a>
                            </li>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" name="name" class="form-control" placeholder="Super Admin" required data-validation-required-message="This title field is required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" id="{{ $list }}" class="custom-control-input" name="{{ $list }}">

...
<head>
    ...
    <title>@yield('page_title', 'MS') - {{ config('app.name', '') }}</title>
...
<body class="vertical-layout vertical-menu-modern dark-layout {{ @$bd_class }}  navbar-floating footer-static bg-full-screen-image  blank-page blank-page " data-open="click" data-menu="vertical-menu-modern" data-col="{{ @$data_col }}" data-layout="dark-layout">
